module MercadoPago
  ...
  class Client
    ...
    attr_reader :access_token, :refresh_token, :token
    ...
    # - client_id
    # - client_secret
    # - token - Represent authorization_code or refresh_code
    #
    ...
    # Generetare authorization_code
    def authorization_code(redirect_uri)
      MercadoPago::Authentication.authorization_code(@client_id, @client_secret, @token, redirect_uri)
    end
    ...
    #
    def credentials
      load_tokens MercadoPago::Authentication.refresh_access_token(@client_id, @client_secret, @token)
    end
